...
# this is an example of how singleton can be implemented into databases
...
if __name__ == "__main__":
    ...
    print(f"Database Objects DB1 = {db1} {db1.db_name}]")
    print(f"Database Objects DB2 = {db2} {db2.db_name}]")
